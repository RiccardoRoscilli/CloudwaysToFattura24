        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cloudways_app_id"
                        value="{{ $application->cloudways_app_id }}" readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="application" value="{{ $application->application }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="app_version" class="form-label">App Version</label>
                    <input type="text" class="form-control" id="app_version" value="{{ $application->app_version }}"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="server_id" value="{{ $application->server_id }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="created_at" class="form-label">Creato il</label>
                    <input type="text" class="form-control" id="created_at" value="{{ $application->created_at }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="updated_at" class="form-label">Aggiornato il</label>
                    <input type="text" class="form-control" id="updated_at" value="{{ $application->updated_at }}"
                        readonly>
                </div>
                            <!-- Colonna Destra -->
                <div class="col-md-6">
                        ...
                        <form action="{{ route('applications.update', $application->id) }}" method="POST">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control" id="price" name="price"
                                    value="{{ $application->price }}" required>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="app_user" value="{{ $application->app_user }}"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="app_password"
                            value="{{ $application->app_password }}" readonly>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="sys_password"
                            value="{{ $application->sys_password }}" readonly>
                        <span class="input-group-text">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="mysql_db_name"
                        value="{{ $application->mysql_db_name }}" readonly>
                </div>

                <div class="mb-3">
                    <label for="mysql_user" class="form-label">MySQL User</label>
                    <input type="text" class="form-control" id="mysql_user" value="{{ $application->mysql_user }}"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="mysql_password"
                            value="{{ $application->mysql_password }}" readonly>
                        <span class="input-group-text">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="webroot" value="{{ $application->webroot }}"
                        readonly>
                </div>

                <div class="mb-3">
                    <label for="is_csr_available" class="form-label">CSR Disponibile</label>
                    <input type="text" class="form-control" id="is_csr_available"
                        value="{{ $application->is_csr_available ? 'Sì' : 'No' }}" readonly>
                </div>

                <div class="mb-3">
                    <label for="lets_encrypt" class="form-label">Let's Encrypt</label>
                    <input type="text" class="form-control" id="lets_encrypt"
                        value="{{ $application->lets_encrypt }}" readonly>
                </div>

                <div class="mb-3">
                    <label for="app_version_id" class="form-label">App Version ID</label>
                    <input type="text" class="form-control" id="app_version_id"
                        value="{{ $application->app_version_id }}" readonly>
                </div>

                <div class="mb-3">
                    <label for="cms_app_id" class="form-label">CMS App ID</label>
                    <input type="text" class="form-control" id="cms_app_id" value="{{ $application->cms_app_id }}"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="customer_name"
                        value="{{ $application->customer->name ?? 'Nessun Cliente Associato' }}" readonly>
                </div>
