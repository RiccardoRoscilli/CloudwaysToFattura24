...
*   **Crrojob che crea automaticamete gli ordini all'inizio di ogni trimestre:** Per la mia attività ho scelto la fatturazione dei servizi ogni 3 mesi, tuttavia ci sono servizi che hanno un costo mensile (hosting magento, wordpress e app laravel, mail su rackspace) e un costo annuale (domini). Il cron tiene traccia delle scadenze e inserisce tutti i servizi all'interno dello stesso ordine in fattura24 pronto per essere fatturato. 
